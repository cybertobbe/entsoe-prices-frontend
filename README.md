A Vue 3 + Vite single-page application that displays Swedish electricity prices (SE3 bidding zone) sourced from the ENTSO-E Transparency Platform via a companion backend API.
